    ...
    <div className="container dashboard">
      <div className="dashboard-header">
        <div>
          ...
          <p className="dashboard-subtitle">Manage and showcase your portfolio work</p>
        </div>
      ...
      {projects.length === 0 ? (
        <div className="empty-state">
          ...
          <p>Get started by adding your first portfolio project to showcase your work.</p>
        ...
        <div className="empty-state">
          ...
          <button onClick={() => setSearchTerm('')} className="btn btn-secondary mt-4">
            Clear Search
          </button>
        </div>
      ) : (
